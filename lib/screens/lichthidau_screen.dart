...
class LichThiDauScreen extends StatelessWidget {
  const LichThiDauScreen({Key? key}) : super(key: key);
  static const routeName = '/lichthidau';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Vòng 16 Night Wlf V.league 11-2022',
                style: TextStyle(
                    fontSize: 20,
              ...
              buildLTD(context, 'Ngày 10 Tháng 11 Năm 2022', '15:00',
                  'SVD Mỹ Đình', 'Đông Á Thanh Hóa', 'Hà Nội'),
              const SizedBox(
                height: 10,
              ),
              buildLTD(context, 'Ngày 11 Tháng 11 Năm 2022', '19:15',
